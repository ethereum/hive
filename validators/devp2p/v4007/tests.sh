...
/devp2p.test -test.v -test.run Discovery/discoveryv4/v4007 -enodeTarget "$TARGET_ENODE" -targetIP "$HIVE_CLIENT_IP" -dockerHost "$HIVE_DOCKER_HOST_ALIAS"-targetID "$HIVE_CLIENT_ID"
