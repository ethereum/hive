...
Ethereum Foundation maintains two public Hive instances to check for consensus, p2p and blockchain compatibility: eth1 consensus, graphql and p2p tests are on <https://hivetests.ethdevops.io>
