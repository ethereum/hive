...
func (s HiveRPCEngineStarter) StartClient(T *hivesim.T, testContext context.Context, genesis client.Genesis, ClientParams hivesim.Params, ClientFiles hivesim.Params, bootClients ...client.EngineClient) (client.EngineClient, error) {
	var (
