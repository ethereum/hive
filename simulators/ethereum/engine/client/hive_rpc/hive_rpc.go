...
func (s HiveRPCEngineStarter) StartClient(T *hivesim.T, ClientParams hivesim.Params, ClientFiles hivesim.Params, bootClient client.EngineClient) (client.EngineClient, error) {
	var (
