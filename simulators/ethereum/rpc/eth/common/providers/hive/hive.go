...
// New looks up the hive host URI using the HIVE_SIMULATOR environment variable and
// returns a new common.TestSuiteHost. It will panic if HIVE_SIMULATOR is not set.
