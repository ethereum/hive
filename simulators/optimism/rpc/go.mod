...
require (
	...
	github.com/ethereum-optimism/optimism/op-chain-ops v0.8.8 // indirect
	github.com/ethereum-optimism/optimism/op-node v0.8.8 // indirect
	github.com/ethereum-optimism/optimism/op-proposer v0.8.8 // indirect
